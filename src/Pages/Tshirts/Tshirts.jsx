...
const allProducts = [
    ...
    {
        id: 'tshirt-6',
        title: "Graphic Print Red T-Shirt",
        price: 20.00,
        oldPrice: 28.00,
        rating: 4.10,
        reviews: 14,
...
const colorsList = [
    ...
    { name: "Green", color: "#7ed321", count: 0 },
    { name: "Red", color: "#ef4444", count: 2 },
...
const brandsList = [
    ...
    { name: "Sportempt", count: 2 },
    { name: "Tomy Hilfiger", count: 0 },
    { name: "UCLA", count: 2 },
];
...
function Tshirts() {
    ...
    useEffect(() => {
        const loadProducts = async () => {
            try {
                ...
                const tshirtDbProducts = res.data.filter(p =>
                    p.category === 'T-shirts' ||
                ...
                const formattedDb = tshirtDbProducts.map(p => ({
                    ...
                    categories: Array.isArray(p.categories) ? p.categories : [p.category || 'T-shirts'],
    ...
    const maxPricePossible = useMemo(() => {
        if (combinedProducts.length === 0) return 100;
